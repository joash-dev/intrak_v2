...
const InstructorDocumentsTab = () => {
  ...
  const [previewDoc, setPreviewDoc] = useState<InstructorDocument | null>(null);
  ...
  const submitReview = async () => {
    ...
    try {
      ...
      if (success) {
        // Show enhanced success toast with status indicator
        toast.custom(
          (t) => (
            <div
              className={`${
            ...
            >
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    <p className="text-sm font-medium text-gray-900 dark:text-white">
                      Document {reviewAction === "approve" ? "Approved" : "Rejected"}
                    </p>
                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                      {selectedDoc.documentType} from {selectedDoc.studentName}
                    </p>
                    <div className="mt-2">
                      <span
                      ...
                      >
                        ...
                        Status changed to {reviewAction === "approve" ? "APPROVED" : "REJECTED"}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex border-l border-gray-200 dark:border-gray-700">
                <button
                  ...
                  className="w-full border border-transparent rounded-none rounded-r-lg p-4 flex items-center justify-center text-sm font-medium text-purple-600 dark:text-purple-400 hover:text-purple-500 focus:outline-none"
                >
                  Close
                </button>
              </div>
  ...
  const handlePreview = async (doc: InstructorDocument) => {
    try {
    ...
    <div className="space-y-6 min-h-screen dark:bg-[#19191c]">
      ...
      {showReviewModal && selectedDoc && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[70] flex items-center justify-center p-4" style={{ margin: "0" }}>
          <div className="bg-white dark:bg-[#212124] rounded-2xl w-full max-w-2xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col">
            {/* Header */}
            ...
            <div className="flex-1 overflow-y-auto px-6 py-5 space-y-5">
              ...
              <div className="bg-gray-50 dark:bg-[#19191c] border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-blue-500 flex items-center justify-center text-white font-semibold text-lg flex-shrink-0">
                  ...
                  {/* Status Badge */}
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs font-semibold flex-shrink-0 ${getStatusColor(
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-gray-50 dark:bg-[#19191c] border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3">
                ...
                <div className="bg-gray-50 dark:bg-[#19191c] border border-gray-200 dark:border-gray-700 rounded-lg px-4 py-3">
                  ...
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{selectedDoc.submittedDate}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-[#19191c] border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none placeholder:text-gray-400 dark:placeholder:text-gray-500"
                />
              </div>
            </div>

            {/* Footer Action Buttons */}
            <div className="flex items-center justify-end space-x-3 px-6 py-4 border-t border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-[#19191c] flex-shrink-0">
              <button
                onClick={() => setShowReviewModal(false)}
              ...
              <button
                ...
                className={`flex items-center space-x-2 px-6 py-2.5 rounded-lg font-medium transition-colors shadow-sm ${reviewAction === "approve"
      ...
      {/* Preview Modal with Feedback Panel */}
      {showPreviewModal && previewUrl && previewDoc && (
        <div 
          className="fixed inset-0 bg-black bg-opacity-75 z-[70] flex items-center justify-center p-2 sm:p-4" 
          onClick={closePreviewModal}
          style={{ margin: "0" }}
        >
          <div 
            className="bg-white dark:bg-[#212124] rounded-xl sm:rounded-2xl w-full max-w-[95vw] lg:max-w-[1400px] max-h-[95vh] overflow-hidden shadow-2xl flex flex-col lg:flex-row"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Left Side - Document Preview */}
            <div className="flex-1 flex flex-col min-w-0 lg:border-r border-gray-200 dark:border-gray-700">
              {/* Header */}
              <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
                <div className="flex items-center space-x-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-base font-semibold text-gray-900 dark:text-white uppercase truncate">
                      {previewDoc.documentType}
                    </h3>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {previewDoc.studentName} • Uploaded {previewDoc.submittedDate}
                    </p>
                  </div>
                </div>
                <button
                  onClick={closePreviewModal}
                  className="lg:hidden p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex-shrink-0"
                  title="Close Preview"
                >
                  <X className="w-5 h-5" />
                </button>
              ...
              {/* PDF Preview */}
              <div className="flex-1 overflow-hidden bg-gray-100 dark:bg-gray-900 min-h-[300px] lg:min-h-[500px]">
                <iframe
                  src={previewUrl}
            ...
            {/* Right Side - Feedback Panel and Actions */}
            <div className="w-full lg:w-[380px] flex flex-col bg-gray-50 dark:bg-[#19191c] max-h-[40vh] lg:max-h-none overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <DocumentFeedbackPanel
                  ...
                  allowFeedback={true}
                  className="bg-white dark:bg-[#212124]"
                  onFeedbackAdded={() => {
                    loadDocuments();
                  }}
                  compact
              ...
              <div className="p-4 border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-[#212124] space-y-3 flex-shrink-0">
                {previewDoc.status === "PENDING" ? (
                  <>
                    <button
                      onClick={() => {
                        closePreviewModal();
                        handleReview(previewDoc, "approve");
                      }}
                      className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-green-600 text-white hover:bg-green-700 rounded-lg transition-colors font-medium"
                    >
                    ...
                    <div className="flex space-x-2">
                      <button
                        onClick={() => {
                          closePreviewModal();
                          openFeedbackModal(previewDoc);
                        }}
                        className="flex-1 flex items-center justify-center space-x-2 px-4 py-2.5 bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300 hover:bg-amber-200 dark:hover:bg-amber-900/50 rounded-lg transition-colors font-medium"
                      >
                      ...
                      <button
                        onClick={() => {
                          closePreviewModal();
                          handleReview(previewDoc, "reject");
                        }}
                        className="flex-1 flex items-center justify-center space-x-2 px-4 py-2.5 bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-900/50 rounded-lg transition-colors font-medium"
                      >
                        <XCircle className="w-4 h-4" />
                        <span>Reject</span>
                      </button>
                  ...
                  <div className="space-y-3">
                    {/* Status Badge */}
                    <div className={`flex items-center justify-center space-x-2 px-4 py-3 rounded-lg ${
                    ...
                    {previewDoc.remarks && (
                      <div className="p-3 bg-gray-100 dark:bg-gray-800 rounded-lg">
                        ...
                        <p className="text-sm text-gray-700 dark:text-gray-300">{previewDoc.remarks}</p>
                      </div>
                    )}
                  </div>
                )}
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 bg-gray-100 text-gray-700 dark:bg-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg transition-colors font-medium"
                >
      ...
      {showFeedbackModal && feedbackDoc && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[70] flex items-center justify-center p-4" style={{ margin: "0" }}>
          <div className="bg-white dark:bg-[#212124] rounded-2xl max-w-3xl w-full shadow-2xl border border-gray-100 dark:border-gray-700 max-h-[90vh] flex flex-col overflow-hidden">
            {/* Header */}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
                    {feedbackDoc.studentName} • {feedbackDoc.documentType}
                  </p>
                </div>
              </div>
              <button
                ...
                className="text-gray-400 hover:text-gray-600 dark:text-gray-400 dark:hover:text-gray-200 p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="px-6 py-3 bg-gray-50 dark:bg-[#19191c] border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <FileText className="w-5 h-5 text-gray-400" />
                  <div>
                    <p className="text-sm font-medium text-gray-900 dark:text-white uppercase">
                      {feedbackDoc.documentType}
                    </p>
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {feedbackDoc.fileName}
                    </p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <span
                    className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-semibold ${getStatusColor(
                      feedbackDoc.status.toUpperCase()
                    )}`}
                  >
                    {getStatusIcon(feedbackDoc.status.toUpperCase())}
                    <span>{feedbackDoc.status.replace(/_/g, " ").toLowerCase()}</span>
                  </span>
                  <span className="text-xs text-gray-500 dark:text-gray-400">
                    Submitted {feedbackDoc.submittedDate}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <DocumentFeedbackPanel
                ...
                typeOptions={["COMMENT", "REQUEST_CHANGES", "APPROVAL_NOTE"]}
              />
            </div>

            {/* Quick Actions Footer */}
            {feedbackDoc.status === "PENDING" && (
              <div className="px-6 py-4 bg-gray-50 dark:bg-[#19191c] border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => {
                        setShowFeedbackModal(false);
                        setFeedbackDoc(null);
                        handleReview(feedbackDoc, "reject");
                      }}
                      className="flex items-center space-x-1.5 px-4 py-2 text-sm bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-900/50 rounded-lg transition-colors font-medium"
                    >
                      <XCircle className="w-4 h-4" />
                      <span>Reject</span>
                    </button>
                    <button
                      onClick={() => {
                        setShowFeedbackModal(false);
                        setFeedbackDoc(null);
                        handleReview(feedbackDoc, "approve");
                      }}
                      className="flex items-center space-x-1.5 px-4 py-2 text-sm bg-green-600 text-white hover:bg-green-700 rounded-lg transition-colors font-medium"
                    >
                      <CheckCircle className="w-4 h-4" />
                      <span>Approve</span>
                    </button>
