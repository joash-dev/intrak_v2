              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="w-full px-4 py-2 border rounded-lg bg-gray-50 dark:bg-gray-800/60 border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-sm">
                      {profileData.email || "—"}
                    </p>
