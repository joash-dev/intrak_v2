                ...
                <div className="space-y-6">
                  ...
                  <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div
                        className={`p-4 border rounded-lg ${systemStatus.storage > 80
                            ? "bg-red-50 dark:bg-red-900/20 border-red-200 dark:border-red-800"
                      ...
                      >
                        <div className="flex items-center space-x-2 mb-2">
                          <div
                            className={`w-3 h-3 rounded-full ${systemStatus.storage > 80
                                ? "bg-red-500"
                                : systemStatus.storage > 60
                                  ? "bg-yellow-500"
                                  : "bg-green-500"
                          ...
                          ></div>
                          <span
                            className={`text-sm font-medium ${systemStatus.storage > 80
                                ? "text-red-800 dark:text-red-200"
                                : systemStatus.storage > 60
                        ...
                        <p
                          className={`text-xs ${systemStatus.storage > 80
                              ? "text-red-600 dark:text-red-400"
                              : systemStatus.storage > 60
